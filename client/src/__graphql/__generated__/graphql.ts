...
export type GetMostReadBooksQuery = {
  __typename?: 'Query'
  books: Array<{
    __typename?: 'BooksStatisticResponse'
    bookTitle: string
...
export type GetMostReadAuthorsQuery = {
  __typename?: 'Query'
  authors: Array<{
    __typename?: 'AuthorsStatisticResponse'
    name: string
...
export type GetReadStatisticQuery = {
  __typename?: 'Query'
  statistic: Array<{ __typename?: 'Statistic'; count: number; period: string }>
}
...
export type GetOneAuthorByIdQuery = {
  __typename?: 'Query'
  author?: {
    __typename?: 'Author'
    name: string
    ...
    series: Array<{
      ...
      booksInSeries: Array<{
        __typename?: 'Book'
        title: string
        bookCoverThumbnail?: string | null
        rating?: number | null
        id: string
      }>
    }>
    booksWithoutSeries: Array<{
      __typename?: 'Book'
      title: string
      bookCoverThumbnail?: string | null
      rating?: number | null
...
export type CreateAuthorMutation = {
  __typename?: 'Mutation'
  authorInfo: { __typename?: 'Author'; surname?: string | null; name: string }
}

export type GetAllAuthorsByBooksCountQueryVariables = Exact<{ [key: string]: never }>

export type GetAllAuthorsByBooksCountQuery = {
  __typename?: 'Query'
  author: Array<{
    __typename?: 'AuthorMostReadResponse'
    name: string
...
export type GetAllBooksByDateQuery = {
  __typename?: 'Query'
  getAllBooksByDate: {
    __typename?: 'ReadBooksResponse'
    totalCount: number
    readDate: Array<{
      ...
      books: {
        ...
        rating?: number | null
        bookCoverThumbnail?: string | null
        author: { __typename?: 'Author'; surname?: string | null; name: string }
      }
    }>
  }
}
...
export type GetOneBookByIdQuery = {
  __typename?: 'Query'
  book?: {
    __typename?: 'Book'
    id: string
    ...
    author: { __typename?: 'Author'; surname?: string | null; name: string; id: string }
    series?: {
      __typename?: 'Series'
      title: string
      booksInSeries: Array<{
    ...
    readDate: Array<{ __typename?: 'ReadDate'; readEnd: any }>
    tags: Array<{ __typename?: 'Tags'; id: string; tag: string }>
  } | null
}
...
export type GetOneBookPlotQuery = {
  __typename?: 'Query'
  book?: { __typename?: 'DescriptionPlot'; plot: string } | null
}
...
export type GetAllBooksBySpecificDateQuery = {
  __typename?: 'Query'
  bookInYear: Array<{
    __typename?: 'ReadDate'
    readEnd: any
...
export type GetBooksByTagQuery = {
  __typename?: 'Query'
  tagData: {
    __typename?: 'Tags'
    tag: string
...
export type CreteBookMutation = {
  __typename?: 'Mutation'
  bookInfo: {
    __typename?: 'Book'
    title: string
    author: { __typename?: 'Author'; name: string; surname?: string | null }
  }
}
...
export type CreateReadDateMutation = {
  __typename?: 'Mutation'
  bookInfo: { __typename?: 'ReadDate'; readEnd: any; books: { __typename?: 'Book'; title: string } }
}
...
export type GetMediaForBookQuery = {
  __typename?: 'Query'
  book?: {
    __typename?: 'Book'
    id: string
    ...
    media?: {
      __typename?: 'AllMediaForItem'
      video: Array<{ __typename?: 'AdditionalMedia'; id: string; type: MediaType; url: string }>
      image: Array<{ __typename?: 'AdditionalMedia'; id: string; url: string; type: MediaType }>
    } | null
  } | null
}
...
export type AddAdditionalMediaMutation = {
  __typename?: 'Mutation'
  bookInfo: { __typename?: 'Book'; title: string; isAdditionalMediaExist: boolean }
}
...
export type SearchInBooksAndAuthorsQuery = {
  __typename?: 'Query'
  search: Array<
...
export type SearchInAuthorsQuery = {
  __typename?: 'Query'
  authors: Array<{ __typename?: 'Author'; id: string; surname?: string | null; name: string }>
}
...
export type SearchInSeriesQuery = {
  __typename?: 'Query'
  series: Array<{ __typename?: 'Series'; id: string; title: string }>
}
...
export type SearchInBooksQuery = {
  __typename?: 'Query'
  books: Array<{
    __typename?: 'Book'
    id: string
...
export type CreateSerieMutation = {
  __typename?: 'Mutation'
  serieInfo: { __typename?: 'Series'; title: string }
}
...
export type CreteLinkedTagMutation = {
  __typename?: 'Mutation'
  book: {
    __typename?: 'Book'
    id: string
...
export const GetMostReadBooksDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetMostReadBooks' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
            ...
            selectionSet: {
              kind: 'SelectionSet',
              selections: [
                { kind: 'Field', name: { kind: 'Name', value: 'bookTitle' } },
...
} as unknown as DocumentNode<GetMostReadBooksQuery, GetMostReadBooksQueryVariables>
export const GetMostReadAuthorsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetMostReadAuthors' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
...
} as unknown as DocumentNode<GetMostReadAuthorsQuery, GetMostReadAuthorsQueryVariables>
export const GetReadStatisticDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetReadStatistic' },
      variableDefinitions: [
        {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            alias: { kind: 'Name', value: 'statistic' },
            name: { kind: 'Name', value: 'getReadStatistic' },
            arguments: [
              {
                kind: 'Argument',
...
} as unknown as DocumentNode<GetReadStatisticQuery, GetReadStatisticQueryVariables>
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetAllAuthors' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      { kind: 'Field', name: { kind: 'Name', value: 'name' } },
                      { kind: 'Field', name: { kind: 'Name', value: 'surname' } },
                      { kind: 'Field', name: { kind: 'Name', value: 'portraitThumbnail' } },
                    ],
                  },
                },
...
} as unknown as DocumentNode<GetAllAuthorsQuery, GetAllAuthorsQueryVariables>
export const GetOneAuthorByIdDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetOneAuthorById' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
        ...
        selections: [
          {
            ...
            name: { kind: 'Name', value: 'getOneAuthor' },
            arguments: [
              {
                kind: 'Argument',
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'portrait' } },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'booksInSeries' },
                        selectionSet: {
                          kind: 'SelectionSet',
                          selections: [
                            { kind: 'Field', name: { kind: 'Name', value: 'title' } },
                            { kind: 'Field', name: { kind: 'Name', value: 'bookCoverThumbnail' } },
...
} as unknown as DocumentNode<GetOneAuthorByIdQuery, GetOneAuthorByIdQueryVariables>
      ...
      variableDefinitions: [
        {
          ...
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'AuthorInput' } },
          },
        },
      ],
      selectionSet: {
...
export const GetAllAuthorsByBooksCountDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetAllAuthorsByBooksCount' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
  ...
  GetAllAuthorsByBooksCountQueryVariables
>
export const GetAllBooksByDateDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetAllBooksByDate' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'page' } },
...
} as unknown as DocumentNode<GetAllBooksByDateQuery, GetAllBooksByDateQueryVariables>
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetOneBookById' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            alias: { kind: 'Name', value: 'book' },
            name: { kind: 'Name', value: 'getOneBook' },
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'id' },
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'description' } },
                {
                  ...
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [{ kind: 'Field', name: { kind: 'Name', value: 'readEnd' } }],
                  },
                },
                {
                  kind: 'Field',
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'bookCover' } },
                { kind: 'Field', name: { kind: 'Name', value: 'isAdditionalMediaExist' } },
              ],
            },
          },
        ],
...
} as unknown as DocumentNode<GetOneBookByIdQuery, GetOneBookByIdQueryVariables>
export const GetOneBookPlotDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
        ...
        selections: [
          {
            ...
            selectionSet: {
              kind: 'SelectionSet',
              selections: [{ kind: 'Field', name: { kind: 'Name', value: 'plot' } }],
            },
          },
        ],
      },
...
} as unknown as DocumentNode<GetOneBookPlotQuery, GetOneBookPlotQueryVariables>
export const GetAllBooksBySpecificDateDocument = {
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetAllBooksBySpecificDate' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'year' } },
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            alias: { kind: 'Name', value: 'bookInYear' },
            name: { kind: 'Name', value: 'getAllBooksBySpecificDate' },
            arguments: [
              {
                kind: 'Argument',
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'readEnd' } },
                { kind: 'Field', name: { kind: 'Name', value: 'id' } },
              ],
            },
          },
  ...
  GetAllBooksBySpecificDateQueryVariables
>
export const GetBooksByTagDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetBooksByTag' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            alias: { kind: 'Name', value: 'tagData' },
            name: { kind: 'Name', value: 'getTagById' },
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'id' },
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'booksInTag' },
                  arguments: [
                    {
                      kind: 'Argument',
...
} as unknown as DocumentNode<GetBooksByTagQuery, GetBooksByTagQueryVariables>
export const CreteBookDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'CreteBook' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
...
} as unknown as DocumentNode<CreteBookMutation, CreteBookMutationVariables>
export const CreateReadDateDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'CreateReadDate' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'ReadDateInput' } },
          },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            alias: { kind: 'Name', value: 'bookInfo' },
            name: { kind: 'Name', value: 'addReadDate' },
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'input' },
...
} as unknown as DocumentNode<CreateReadDateMutation, CreateReadDateMutationVariables>
export const GetMediaForBookDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'title' } },
                {
                  ...
                  name: { kind: 'Name', value: 'additionalMedia' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      {
...
} as unknown as DocumentNode<GetMediaForBookQuery, GetMediaForBookQueryVariables>
export const AddAdditionalMediaDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: 'ListType',
              type: { kind: 'NamedType', name: { kind: 'Name', value: 'AdditionalMediaInput' } },
            },
          },
        },
      ],
...
} as unknown as DocumentNode<AddAdditionalMediaMutation, AddAdditionalMediaMutationVariables>
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'SearchInBooksAndAuthors' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
...
} as unknown as DocumentNode<SearchInBooksAndAuthorsQuery, SearchInBooksAndAuthorsQueryVariables>
export const SearchInAuthorsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'SearchInAuthors' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'searchString' } },
...
} as unknown as DocumentNode<SearchInAuthorsQuery, SearchInAuthorsQueryVariables>
export const SearchInSeriesDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'SearchInSeries' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'searchString' } },
...
} as unknown as DocumentNode<SearchInSeriesQuery, SearchInSeriesQueryVariables>
export const SearchInBooksDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'SearchInBooks' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'searchString' } },
...
} as unknown as DocumentNode<SearchInBooksQuery, SearchInBooksQueryVariables>
export const CreateSerieDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'CreateSerie' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'SerieInput' } },
          },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            alias: { kind: 'Name', value: 'serieInfo' },
            name: { kind: 'Name', value: 'createSerie' },
            arguments: [
              {
                kind: 'Argument',
...
} as unknown as DocumentNode<CreateSerieMutation, CreateSerieMutationVariables>
...
export const CreteLinkedTagDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'CreteLinkedTag' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'BookTagRelationsInput' } },
          },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            alias: { kind: 'Name', value: 'book' },
            name: { kind: 'Name', value: 'linkBookWithTag' },
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'input' },
...
} as unknown as DocumentNode<CreteLinkedTagMutation, CreteLinkedTagMutationVariables>
